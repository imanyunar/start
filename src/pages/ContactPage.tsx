...
import { Mail, Phone, X, ExternalLink, GitBranch, Send } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          >
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-12 max-w-md">
              Whether you're looking to automate complex workflows or architect a new digital ecosystem, our laboratory is ready to assist.
            </p>
